<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DelegateBySupervisor.aspx.cs" Inherits="ADProjectSA43_Team1.StoreClerk.ChangeSupervisor" %>
...
<div class="container-fluid pg-content">
    <div class="row">
        <div class="col-md-6">
            <h2><i class="fa fa-user"></i> Current Store Supervisor: <asp:Label ID="lblCurrentRepresentative" runat="server" Text=""></asp:Label></h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4" style="margin-top:10px;">
            <div class="row">
                ...
                <div class="col-md-6">
                   <asp:Button ID="btnRemoveManager" runat="server" Text="Remove Supervisor" CssClass="btn btn-danger" OnClick="btnRemoveManager_Click" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
       <div class="col-md-12 maintable">
            ...
            <asp:GridView ID="changeSupervisorGV" runat="server" AutoGenerateColumns="False" GridLines="Horizontal" Height="100%" Width="100%" CellPadding="3" BorderWidth="0px" CssClass="table" AllowPaging="True" OnPageIndexChanging="changeSupervisorGV_PageIndexChanging">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-2 col-md-offset-1">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Assign Supervisor</button>
            </div>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="btnChange" runat="server" Text="Change Supervisor" CssClass="btn btn-warning" OnClick="btnChange_Click" ValidationGroup="check" />
                    </div>
                    </div>
                 </div>
    </div>
